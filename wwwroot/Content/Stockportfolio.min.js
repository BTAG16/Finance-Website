...
let e=hB((hK) => class hL { static { e=hK(this);} static Main;static currentPage;static router;static EquityModel;static EquityData;static random;static stockA;static stockN;static stockP;static totalExpensesView;static totalIncomeView;static balanceView;static storage_e;static storage_i;static expensegroup;static loss;static totalE;static gain;static incomegroup;static totalG;static { const hM=[n.Create_1(""), n.Create_1(0), n.Create_1(0)];this.totalG=hM[2];this.incomegroup=hM[0];this.gain=hM[1];const hN=[n.Create_1(""), n.Create_1(0), n.Create_1(0)];this.totalE=hN[2];this.loss=hN[1];this.expensegroup=hN[0];const hO=[n.Create_1([h.Empty, h.Empty]), n.Create_1([h.Empty, h.Empty])];this.storage_i=hO[0];this.storage_e=hO[1];this.balanceView=D((hZ, h0) =>(hZ-h0).toFixed(2), p().View, o().View);this.totalIncomeView=E((hZ) => hZ.toFixed(2), p().View);this.totalExpensesView=E((hZ) => hZ.toFixed(2), o().View);const hP=[n.Create_1(""), n.Create_1(0), n.Create_1(0)];this.stockP=hP[2];this.stockN=hP[0];this.stockA=hP[1];this.random=new j();this.EquityData=h.Empty;const hQ=u0035((hZ) => hZ.Name, T());let hR=(F((hZ) => { S(u0037(hZ));}, hQ.v),hQ);this.EquityModel=hR;this.router=bg();this.currentPage=bk({$:0}, c());const hS=c_.EmbedView(E((hZ) => hZ.$==1?U():q(), d().View));const hT=new bs("New_1");const hU=(hT.h.push(new c6("balances", "/#/")),hT);const hV=(hU.h.push(new c6("equities", "/#/stockPortfolio")),hU);const hW=(hV.h.push(new c5("pagecontent", hS)),hV);const hX=c9(hW.k, hW.h, []);let hY=hW.i=new c4(hX[1], ev(hX[0]));this.Main=hY;} });
...
function q(){ const hK=new bs("New_1");const hL=(hK.h.push(new dD("incomegroup", x())),hK);const hM=(hL.h.push(new dC("gains", w())),hL);const hN=(hM.h.push(new dD("expensegroup", v())),hM);const hO=(hN.h.push(new dC("losses", u())),hN);const hP=(hO.h.push(new dB("income", t())),hO);const hQ=(hP.h.push(new dB("expenses", s())),hP);const hR=(hQ.h.push(new dB("balance", r())),hQ);const hS=(hR.h.push(c8(hR.k, "gainings", () => hR.i, () => { if(!dF(x().Get())&&w().Get()!==0)y();})),hR);const hT=(hS.h.push(c8(hS.k, "losings", () => hS.i, () => { if(!dF(v().Get())&&u().Get()!==0)z();})),hS);const hU=c9(hT.k, hT.h, [["incomegroup", 0, null], ["gains", 1, null], ["expensegroup", 0, null], ["losses", 1, null]]);const hV=new c4(hU[1], bj(hU[0]));let hW=(hT.i=hV,hV);return hW.Doc;}
function r(){ return e.balanceView;}
function s(){ return e.totalExpensesView;}
function t(){ return e.totalIncomeView;}
function u(){ return e.loss;}
function v(){ return e.expensegroup;}
function w(){ return e.gain;}
function x(){ return e.incomegroup;}
function y(){ const hK=p().Get();const hL=x().Get();const hM=w().Get();const hN=A().Get();const hO=B(hK, hL, hM, hN[0], hN[1]);A().Set([hO[0], hO[1]]);p().Set(hO[2]);x().Set("");w().Set(0);}
function z(){ const hK=o().Get();const hL=v().Get();const hM=u().Get();const hN=C().Get();const hO=B(hK, hL, hM, hN[0], hN[1]);C().Set([hO[0], hO[1]]);o().Set(hO[2]);v().Set("");u().Set(0);}
function A(){ return e.storage_i;}
function B(hK, hL, hM, hN, hO){ return[be(hN, u0038([hL])), be(hO, u0038([hM])), hK+hM];}
function C(){ return e.storage_e;}
function D(hK, hL, hM){ return G(() => by(hK, hL(), hM()));}
function E(hK, hL){ return G(() => bz(hK, hL()));}
function F(hK, hL){ function hM(){ bA(hL(), hK, () => { co().Fork(hM);});} co().Fork(hM);}
function G(hK){ const hL={c:null, o:hK};return() => { let hM=hL.c;if(hM===null){ hM=hL.o();hL.c=hM;const hN=hM.s;if(hN!=null&&hN.$==0)hL.o=null;else bB(hM, () => { hL.c=null;});return hM;} else return hM;};}
function H(hK, hL){ return I(E(hK, hL));}
function I(hK){ return G(() => bK(hK()));}
function J(hK, hL){ return K((hM) => hM, hK, hL);}
function K(hK, hL, hM){ const hN=[new bu("New_5")];return E((hO) => { const hP=hN[0];const hQ=new bu("New_5");const hR=gi((hS) => { const hT=hK(hS);const hU=hP.ContainsKey(hT)?hP.Item(hT):hL(hS);hQ.set_Item(hT, hU);return hU;}, dh(hO));hN[0]=hQ;return hR;}, hM);}
function L(hK){ const hL={s:db(hK)};return() => hL;}
function M(hK, hL, hM, hN){ return G(() => bL(hK, hL(), hM(), hN()));}
function N(hK){ return G(() => bM(b2((hL) => hL(), hK)));}
function O(hK, hL){ return G(() => bN(hK(), hL()));}
function P(hK){ throw new Error(hK);}
function Q(hK){ return[hK.K, hK.V];}
function R(hK, hL){ const hM=1+hL-hK;return hM<=0?[]:ci(hM, (hN) => hN+hK);}
function S(hK){ const hL=JSON.stringify(((cE(cF()))())(hK));globalThis.localStorage.setItem("stocks", hL);}
function T(){ const hK=globalThis.localStorage.getItem("stocks");if(hK==null)return V();else try { return u0039((hL) => l(hL.Name, hL.Amount, hL.Price, W(hL.Price)), ((cG(cF()))())(JSON.parse(hK)));} catch(hL){ return V();} }
function U(){ X();const hK=(h6) => h6.LatestPrice*h6.Amount;const hL=E((h6) => bX(hK, h6), Y().v);const hM=(h6) => h6.LatestPrice*h6.Amount-h6.Price*h6.Amount;const hN=E((h6) => bX(hM, h6), Y().v);const hO=E((h6) => h6>=0?"rgb(0, 255, 0)":"red", hN);const hP=D((h6, h7) =>(h7*100/h6).toFixed(2), hL, hN);const hQ=E((h6) => h6.toFixed(2)+"$", hN);const hR=E((h6) => h6.toFixed(2)+"$", hL);const hS=c_.Convert((h6) => { const h7=h6.Amount*h6.Price;const h8=h6.LatestPrice*h6.Amount;const h9=[h7, h8, h8-h7, (it) => it.toFixed(2)];const h_=h9[2];const h$=h9[3];const ia=h$(h9[1]);const ib=h$(h9[0]);const ic=h$(h_);const id=h$(h6.LatestPrice);const ie=h$(h6.Price);const if_1=h$(h6.Amount);const ig=new bs("New_1");const ih=(ig.h.push(new c6("assetname", h6.Name)),ig);const ii=(ih.h.push(new c6("assetquantity", if_1)),ih);const ij=(ii.h.push(new c6("assetprice", ie)),ii);const ik=(ij.h.push(new c6("assetcurrentprice", id)),ij);const il=(ik.h.push(new c6("color", h_>=0?"rgb(0, 255, 0)":"red")),ik);const im=(il.h.push(new c6("assetpandl", ic)),il);const in_1=(im.h.push(new c6("assetcostbasis", ib)),im);const io=(in_1.h.push(new c6("marketvalue", ia)),in_1);const ip=(io.h.push(c8(io.k, "remove", () => io.i, () => { Y().RemoveByKey(h6.Name);})),io);const iq=c9(ip.k, ip.h, []);const ir=new c4(iq[1], bh(iq[0]));let is=(ip.i=ir,ir);return is.Doc;}, Y().v);const hT=new bs("New_1");const hU=(hT.h.push(new c5("portfoliotablebody", hS)),hT);const hV=(hU.h.push(new dD("assetname", u0031())),hU);const hW=(hV.h.push(new dC("assetquantity", u0030())),hV);const hX=(hW.h.push(new dC("assetprice", Z())),hW);const hY=(hX.h.push(new dB("portfoliovalue", hR)),hX);const hZ=(hY.h.push(new dB("portfoliopandl", hQ)),hY);const h0=(hZ.h.push(new dB("portfoliopercent", hP)),hZ);const h1=(h0.h.push(new dB("colorpl", hO)),h0);const h2=(h1.h.push(c8(h1.k, "add", () => h1.i, () => { const h6=u0031();const h7=u0030();const h8=Z();if(!dF(h6.Get())&&h7.Get()>0&&h8.Get()>0){ const h9=l(u0032(h6.Get()), h7.Get(), h8.Get(), W(h8.Get()));Y().Append(h9);h6.Set("");h7.Set(0);h8.Set(0);} })),h1);const h3=c9(h2.k, h2.h, [["assetname", 0, null], ["assetquantity", 1, null], ["assetprice", 1, null]]);const h4=new c4(h3[1], bi(h3[0]));let h5=(h2.i=h4,h4);return h5.Doc;}
function V(){ return e.EquityData;}
function W(hK){ return hK*(1+((u0033(),Math.random())-0.5)*0.2);}
function X(){ const hK=null;cu(cp(() => cq(() => true, cp(() => cr(cs(5000), () => { u0034();return ct();})))), null);}
function Y(){ return e.EquityModel;}
function Z(){ return e.stockP;}
function u0030(){ return e.stockA;}
function u0031(){ return e.stockN;}
function u0032(hK){ let hL;return dF(hK)?hK:(hL=hK[0],String(hL)).toUpperCase()+hK.substring(1).toLowerCase();}
function u0033(){ return e.random;}
function u0034(){ Y().Iter((hK) => { const hL=W(hK.Price);Y().UpdateBy((hM) => hM.Name==hK.Name?bw(l(hM.Name, hM.Amount, hM.Price, hL)):null, hK.Name);});}
...
function bf(){ return P("The input list was empty.");}
...
function bq(hK, hL){ if(hL<0||hL>=hK.length)P("Index was outside the bounds of the array.");}
...
let bu=hB((hK) => class hL extends f { static { bu=hK(this);} equals;hash;count;data;set_Item(hM, hN){ this.set(hM, hN);} TryGetValue(hM, hN){ const hO=this.data[this.hash(hM)];if(hO==null)return false;else { const hP=dq((hQ) => { const hR=Q(hQ);return this.equals.apply(null, [hR[0], hM])?bw(hR[1]):null;}, hO);return hP!=null&&hP.$==1&&(hN.set(hP.$0),true);} } RemoveKey(hM){ return this.remove(hM);} GetEnumerator(){ return cL(dr(cD(this.data)));} set(hM, hN){ const hO=this.hash(hM);const hP=this.data[hO];if(hP==null){ this.count=this.count+1;this.data[hO]=new Array({K:hM, V:hN});} else { const hQ=do_1((hR) => this.equals.apply(null, [(Q(hR))[0], hM]), hP);if(hQ==null){ this.count=this.count+1;hP.push({K:hM, V:hN});} else hP[hQ.$0]={K:hM, V:hN};} } remove(hM){ const hN=this.hash(hM);const hO=this.data[hN];if(hO==null)return false;else { const hP=ds((hQ) =>!this.equals.apply(null, [(Q(hQ))[0], hM]), hO);return bp(hP)<hO.length&&(this.count=this.count-1,this.data[hN]=hP,true);} } ContainsKey(hM){ const hN=this.data[this.hash(hM)];return hN==null?false:du((hO) => this.equals.apply(null, [(Q(hO))[0], hM]), hN);} Item(hM){ return this.get(hM);} get Values(){ return new gm(this);} get Keys(){ return new gJ(this);} get(hM){ const hN=this.data[this.hash(hM)];return hN==null?eU():dx((hO) => { const hP=Q(hO);return this.equals.apply(null, [hP[0], hM])?bw(hP[1]):null;}, hN);} static New_5(){ return new this("New_5");} static New_6(hM, hN, hO){ return new this("New_6", hM, hN, hO);} constructor(hM, hN, hO, hP){ if(hM=="New_5"){ hM="New_6";hN=[];hO=cM;hP=cP;} if(hM=="New_6"){ const hQ=hN;const hR=hO;const hS=hP;super();this.equals=hR;this.hash=hS;this.count=0;this.data=[];const hT=cI(hQ);try { while(hT.MoveNext()){ const hU=hT.Current;this.set(hU.K, hU.V);} } finally { if(typeof hT=="object"&&a(hT))hT.Dispose();} } } });
...
function bM(hK){ const hL=dh(hK);if(hL.length==0)return{s:db([])};else { const hM={s:dc([], [])};const hN=[bp(hL)-1];const hO=() => { if(hN[0]===0){ const hP=dv((hQ) => { const hR=hQ.s;return hR!=null&&hR.$==0?hR.$0:hR!=null&&hR.$==2?hR.$0:P("value not found by View.Sequence");}, hL);if(dk((hQ) => { const hR=hQ.s;return hR!=null&&hR.$==0;}, hL))bF(hM, hP);else bG(hM, hP);} else hN[0]=hN[0]-1;};dp((hP) => { bH(hP, hO, hM);}, hL);return hM;} }
...
function cj(){ return P("The input sequence was empty.");}
...
function cC(hK){ return(hL) => { const hM=[false];const hN=(hO) => { if(hM[0])P("A continuation provided by Async.FromContinuations was invoked multiple times");else { hM[0]=true;co().Fork(hO);} };hK((hO) => { hN(() => { hL.k(eX(hO));});}, (hO) => { hN(() => { hL.k(eW(hO));});}, (hO) => { hN(() => { hL.k(eY(hO));});});};}
...
let c4=hB((hK) => class hL extends f { static { c4=hK(this);} doc;allVars;anchorRoot;get Doc(){ return this.doc;} SetAnchorRoot(hM){ this.anchorRoot=hM;} constructor(hM, hN){ super();this.doc=hN;this.allVars=hM.$==0?hM.$0:P("Should not happen");this.anchorRoot=null;} });
...
function c9(hK, hL, hM){ const hN=new bu("New_5");const hO=new en("New_3");const hP=cI(hL);try { while(hP.MoveNext()){ const hQ=hP.Current;const hR=hQ.Name;hO.SAdd(hR);hN.set_Item(hR, hQ);} } finally { if(typeof hP=="object"&&a(hP))hP.Dispose();} return[b0(hL, dn((hS) => { const hT=hS[0];const hU=hS[1];const hV=hS[2];if(hO.Contains(hT))return null;else { const hW=hU===0?eo.GetOrAddHoleFor(hK, hT, () => { const hX=hV==null?null:bw(hV.$0);let hY=n.Create_1(hX==null?"":hX.$0);return new dD(hT, hY);}):hU===1?eo.GetOrAddHoleFor(hK, hT, () => { const hX=hV==null?null:bw(hV.$0);let hY=n.Create_1(hX==null?0:hX.$0);return new dC(hT, hY);}):hU===2?eo.GetOrAddHoleFor(hK, hT, () => { const hX=hV==null?null:bw(hV.$0);let hY=n.Create_1(hX==null?false:hX.$0);return new ep(hT, hY);}):hU===3?eo.GetOrAddHoleFor(hK, hT, () => { const hX=hV==null?null:bw(hV.$0);let hY=n.Create_1(hX==null?-8640000000000000:hX.$0);return new eq(hT, hY);}):hU===4?eo.GetOrAddHoleFor(hK, hT, () => new er(hT, n.Create_1([]))):hU===5?eo.GetOrAddHoleFor(hK, hT, () => new es(hT, n.Create_1(bw(globalThis.document.querySelector("[ws-dom="+hT+"]"))))):hU===6?eo.GetOrAddHoleFor(hK, hT, () => { const hX=hV==null?null:bw(hV.$0);let hY=n.Create_1(hX==null?[]:hX.$0);return new et(hT, hY);}):P("Invalid value type");hN.set_Item(hT, hW);return bw(hW);} }, hM)), {$:0, $0:hN}];}
let c_=hB((hK) => class hL extends f { static { c_=hK(this);} docNode;updates;static EmbedView(hM){ const hN=dR();return c_.Mk(eb(hN), E(() => { }, H((hO) => { dS(hN, hO.docNode);return hO.updates;}, hM)));} static Mk(hM, hN){ return new hL(hM, hN);} static Convert(hM, hN){ return c_.Flatten(J(hM, hN));} static RunInPlace(hM, hN, hO){ const hP=dT(hN, hO.docNode);F(fr()||fy()?fz(dU(hM, hP, hO.docNode)):() => { dV(hM, hP, hO.docNode);}, hO.updates);} static Flatten(hM){ return c_.EmbedView(E(c_.Concat, hM));} static get Empty(){ return c_.Mk(null, L());} static Concat(hM){ return gh(c_.Empty, c_.Append, gj(hM));} static TextNode(hM){ return c_.Mk(ed(globalThis.document.createTextNode(hM)), L());} static TextView(hM){ const hN=d4();return c_.Mk(ee(hN), E((hO) => { d5(hN, hO);}, hM));} static Append(hM, hN){ return c_.Mk(ef(hM.docNode, hN.docNode), O(hM.updates, hN.updates));} constructor(hM, hN){ super();this.docNode=hM;this.updates=hN;} });
...
function dl(hK, hL){ if(hK<0)P("Negative size given.");else null;const hM=new Array(hK);for(let hN=0, hO=hK-1;hN<=hO;hN++)hM[hN]=hL(hN);return hM;}
function dm(hK, hL){ if(hK.length!==hL.length)P("The arrays have different lengths.");}
...
function dx(hK, hL){ const hM=dq(hK, hL);return hM==null?P("KeyNotFoundException"):hM.$0;}
...
let dC=hB((hK) => { hF(bt);return class hL extends bt { static { dC=hK(this);} name;fillWith;get Name(){ return this.name;} ForTextView(){ return bw(E(String, this.fillWith.View));} AddAttribute(hM, hN){(hM(hN))(f6(this.fillWith));} get AsChoiceView(){ return gg(E(String, this.fillWith.View));} constructor(hM, hN){ super();this.name=hM;this.fillWith=hN;} };});
let dD=hB((hK) => { hF(bt);return class hL extends bt { static { dD=hK(this);} name;fillWith;get Name(){ return this.name;} ForTextView(){ return bw(this.fillWith.View);} AddAttribute(hM, hN){(hM(hN))(f7(this.fillWith));} get AsChoiceView(){ return gg(E(String, this.fillWith.View));} constructor(hM, hN){ super();this.name=hM;this.fillWith=hN;} };});
...
let eh=hB((hK) => class hL extends f { static { eh=hK(this);} s;c;n;d;e;MoveNext(){ const hM=this.n(this);this.e=hM?1:2;return hM;} get Current(){ return this.e===1?this.c:this.e===0?P("Enumeration has not started. Call MoveNext."):P("Enumeration already finished.");} Dispose(){ if(this.d)this.d(this);} constructor(hM, hN, hO, hP){ super();this.s=hM;this.c=hN;this.n=hO;this.d=hP;this.e=0;} });
...
let ep=hB((hK) => { hF(bt);return class hL extends bt { static { ep=hK(this);} name;fillWith;get Name(){ return this.name;} ForTextView(){ return bw(E(String, this.fillWith.View));} AddAttribute(hM, hN){(hM(hN))(f8(this.fillWith));} get AsChoiceView(){ return gg(E(String, this.fillWith.View));} constructor(hM, hN){ super();this.name=hM;this.fillWith=hN;} };});
let eq=hB((hK) => { hF(bt);return class hL extends bt { static { eq=hK(this);} name;fillWith;get Name(){ return this.name;} ForTextView(){ return bw(E((hM) =>(new Date(hM)).toLocaleString(), this.fillWith.View));} AddAttribute(hM, hN){(hM(hN))(f9(this.fillWith));} get AsChoiceView(){ return gg(E((hM) =>(new Date(hM)).toLocaleString(), this.fillWith.View));} constructor(hM, hN){ super();this.name=hM;this.fillWith=hN;} };});
let er=hB((hK) => { hF(bt);return class hL extends bt { static { er=hK(this);} name;fillWith;get Name(){ return this.name;} ForTextView(){ return bw(E(String, this.fillWith.View));} AddAttribute(hM, hN){(hM(hN))(f_(this.fillWith));} get AsChoiceView(){ return gg(E(String, this.fillWith.View));} constructor(hM, hN){ super();this.name=hM;this.fillWith=hN;} };});
...
let et=hB((hK) => { hF(bt);return class hL extends bt { static { et=hK(this);} name;fillWith;get Name(){ return this.name;} ForTextView(){ return bw(E((hM) => dM(",", hM), this.fillWith.View));} AddAttribute(hM, hN){(hM(hN))(f$(this.fillWith));} get AsChoiceView(){ return gg(E(String, this.fillWith.View));} constructor(hM, hN){ super();this.name=hM;this.fillWith=hN;} };});
...
function fb(hK, hL){ const hM=(hN) => { eH(hK, "["+hN+"]", (hO) => { let hP;const hQ=(hP=null,[hL.TryGetValue(hO.getAttribute(hN).toLowerCase(), {get:() => hP, set:(hR) => { hP=hR;}}), hP]);if(hQ[0])hO.setAttribute(hN, hQ[1]);});};hM("ws-hole");hM("ws-replace");hM("ws-attr");hM("ws-onafterrender");hM("ws-var");eH(hK, "[ws-on]", (hN) => { hN.setAttribute("ws-on", dM(" ", dv((hO) => { let hP;const hQ=dI(hO, [":"], 1);const hR=(hP=null,[hL.TryGetValue(bo(hQ, 1), {get:() => hP, set:(hS) => { hP=hS;}}), hP]);return hR[0]?bo(hQ, 0)+":"+hR[1]:hO;}, dI(hN.getAttribute("ws-on"), [" "], 1))));});eH(hK, "[ws-attr-holes]", (hN) => { const hO=dI(hN.getAttribute("ws-attr-holes"), [" "], 1);for(let hP=0, hQ=hO.length-1;hP<=hQ;hP++)((() => { const hR=bo(hO, hP);return hN.setAttribute(hR, cb((hS, hT) => { const hU=Q(hT);return hS.replace(new RegExp("\\${"+hU[0]+"}", "ig"), "${"+hU[1]+"}");}, hN.getAttribute(hR), hL));})());});}
...
let fq=hB((hK) => { hF(c_);return class hL extends c_ { static { fq=hK(this);} docNode_1;updates_1;elt;rvUpdates;static TreeNode(hM, hN){ const hO=gl.Create(hN);const hP=dv((hS) => fL(hS[1]), hM.Attrs);let hQ=gh(L(), O, hP);let hR=O(hQ, hO.v);return new hL(ec(hM), hR, bo(hM.Els, 0), hO);} constructor(hM, hN, hO, hP){ super(hM, hN);this.docNode_1=hM;this.updates_1=hN;this.elt=hO;this.rvUpdates=hP;} };});
...
function fL(hK){ return gk((hL) => hL.NChanged, L(), O, hK.DynNodes);}
...
function gE(){ return P("The input sequence has an insufficient number of elements.");}
...
function gI(){ return P("The input must be non-negative.");}
...
function g6(hK, hL, hM){ let hN;hN=null;return[(hO) => { hO.addEventListener("change", () => { hM.UpdateMaybe((hP) => { let hQ;hN=hK(hO);return hN!=null&&hN.$==1&&(hN.$0!==hP&&(hQ=[hN, hN.$0],true))?hQ[0]:null;});});}, (hO) => { const hP=hL(hO);return(hQ) => hQ==null?null:hP(hQ.$0);}, E((hO) => { let hP;return hN!=null&&hN.$==1&&(cM(hN.$0, hO)&&(hP=hN.$0,true))?null:bw(hO);}, hM.View)];}
