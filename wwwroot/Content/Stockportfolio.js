...
import { Lazy, Create as Create_2, MarkResizable, SetOptional, Force, GetOptional, CreateFuncWithArgs, DeleteEmptyFields, OnLoad } from "./WebSharper.Core.JavaScript/Runtime.js"
...
let _c=Lazy((_i) => class $StartupCode_Client {
  ...
  static totalG;
  static {
    const _1=[_c_7.Create_1(""), _c_7.Create_1(0), _c_7.Create_1(0)];
    this.totalG=_1[2];
    this.incomegroup=_1[0];
    this.gain=_1[1];
    const _2=[_c_7.Create_1(""), _c_7.Create_1(0), _c_7.Create_1(0)];
    this.totalE=_2[2];
    this.loss=_2[1];
    this.expensegroup=_2[0];
    const _3=[_c_7.Create_1([_c_3.Empty, _c_3.Empty]), _c_7.Create_1([_c_3.Empty, _c_3.Empty])];
    this.storage_i=_3[0];
    this.storage_e=_3[1];
    this.balanceView=Map2((_7, _8) =>(_7-_8).toFixed(2), totalG().View, totalE().View);
    this.totalIncomeView=Map((_7) => _7.toFixed(2), totalG().View);
    this.totalExpensesView=Map((_7) => _7.toFixed(2), totalE().View);
    const _4=[_c_7.Create_1(""), _c_7.Create_1(0), _c_7.Create_1(0)];
    this.stockP=_4[2];
    this.stockN=_4[0];
    this.stockA=_4[1];
    this.random=new _c_5();
    this.EquityData=_c_3.Empty;
    const model=Create((asset) => asset.Name, loader());
    let _5=(Sink((st) => {
      saver(ofSeq(st));
    }, model.v),model);
    this.EquityModel=_5;
    ...
    const P=_c_16.EmbedView(Map((link) => link.$==1?StockFlowPage():CashFlowPage(), currentPage().View));
    const this_1=new _c_8("New_1");
    const this_2=(this_1.h.push(new _c_15("balances", "/#/")),this_1);
    const this_3=(this_2.h.push(new _c_15("equities", "/#/stockPortfolio")),this_2);
    const builder=(this_3.h.push(new _c_14("pagecontent", P)),this_3);
    const p=CompleteHoles(builder.k, builder.h, []);
    let _6=builder.i=new _c_13(p[1], RunFullDocTemplate(p[0]));
    this.Main=_6;
  }
});
...
let _c_3=Lazy((_i) => class FSharpList {
  static {
    _c_3=_i(this);
  }
  static Empty=Create_2(_c_3, {$:0});
...
let _c_5=Lazy((_i) => class Random extends _c_1 {
  static {
    _c_5=_i(this);
  }
});
let _c_6=Lazy((_i) => class ListModel extends _c_1 {
  static {
    _c_6=_i(this);
  }
  key;
  ...
  constructor(i, _1, _2, _3){
    ...
    if(i=="New"){
      ...
      i="New_3";
      _1=key;
      _2=_c_7.Create_1(ofSeq_1(distinctBy(key, storage.SInit())));
      _3=storage;
    }
    if(i=="New_3"){
      const key_1=_1;
      ...
      this.it=new _c_10("New_5");
    }
  }
});
function New(Name, Amount, Price, LatestPrice){
  return{
    Name:Name, 
    Amount:Amount, 
    Price:Price, 
...
function New_1(Parse_1, Write_1){
...
function CashFlowPage(){
  ...
  const this_3=(this_2.h.push(new _c_19("gains", gain())),this_2);
  const this_4=(this_3.h.push(new _c_20("expensegroup", expensegroup())),this_3);
  const this_5=(this_4.h.push(new _c_19("losses", loss())),this_4);
  const this_6=(this_5.h.push(new _c_18("income", totalIncomeView())),this_5);
  const this_7=(this_6.h.push(new _c_18("expenses", totalExpensesView())),this_6);
  const t=(this_7.h.push(new _c_18("balance", balanceView())),this_7);
...
function totalExpensesView(){
  return _c.totalExpensesView;
}
function totalIncomeView(){
  return _c.totalIncomeView;
}
function loss(){
  return _c.loss;
}
function expensegroup(){
  return _c.expensegroup;
}
function gain(){
  return _c.gain;
}
function incomegroup(){
  return _c.incomegroup;
}
function addIncome(){
  const t=totalG().Get();
...
function addTransaction(totalValue, categoryValue, amountValue, labels, data){
  return[append(labels, ofArray([categoryValue])), append(data, ofArray([amountValue])), totalValue+amountValue];
}
function storage_e(){
  return _c.storage_e;
}
...
function MapSeqCachedBy(key, conv, view){
  const state=[new _c_10("New_5")];
  return Map((xs) => {
    const prevState=state[0];
    const newState=new _c_10("New_5");
...
function ofSeq(s){
  if(s instanceof _c_3)return s;
    ...
    try {
      let r;
      let go=e.MoveNext();
      if(!go)return _c_3.Empty;
      else {
        const res=Create_2(_c_3, {$:1});
        r=res;
        while(go)
          {
            r.$0=e.Current;
            if(e.MoveNext()){
              const t=Create_2(_c_3, {$:1});
              r=(r.$1=t,t);
            }
            else go=false;
          }
...
function ofArray(arr){
  let r=_c_3.Empty;
  for(let i=length(arr)-1, _1=0;i>=_1;i--)r=_c_3.Cons(get(arr, i), r);
  return r;
}
function map(f, x){
  let r;
...
function Router_EndPoint(){
  return JSUnion(void 0, [[null, [[null, []]], []], [null, [[null, ["stockPortfolio"]]], []]]);
}
function assetlist(h){
  LoadLocalTemplates("index");
  return h?NamedTemplate("index", Some("assetlist"), h):void 0;
}
...
function InstallHashInto(var_1, onParseError, router_1){
  const parse=(h) => Parse(router_1, _c_12.FromHash(h, Some(true)));
...
let _c_8=Lazy((_i) => class ProviderBuilder extends _c_1 {
  static {
    _c_8=_i(this);
  }
  i;
...
let _c_9=Lazy((_i) => class TemplateHole extends _c_1 {
  static {
    _c_9=_i(this);
  }
  ForTextView(){
...
let _c_10=Lazy((_i) => class Dictionary extends _c_1 {
  static {
    _c_10=_i(this);
  }
  equals;
...
function distinctBy(f, s){
  return{GetEnumerator:() => {
    const o=Get(s);
    const seen=new _c_25("New_3");
    return new _c_23(null, null, (e) => {
      let cur;
      let has;
      if(o.MoveNext()){
        cur=o.Current;
...
function map2(f, s1, s2){
  return{GetEnumerator:() => {
    const e1=Get(s1);
    const e2=Get(s2);
    return new _c_23(null, null, (e) => e1.MoveNext()&&e2.MoveNext()&&(e.c=f(e1.Current, e2.Current),true), () => {
      e1.Dispose();
      e2.Dispose();
    });
  }};
...
function unfold(f, s){
  return{GetEnumerator:() => new _c_23(s, null, (e) => {
    const m=f(e.s);
  ...
  return New_1((path) => collect((_1) => {
    ...
    if(isCorrectMethod(_1[1], path.Method)){
      ...
      if(m==null)return[];
        ...
        if(m_1.$==0)return[[_c_12.New(p, path.QueryArgs, path.FormData, path.Method, path.Body), createCase(i, [])]];
        else {
          function collect_1(fields){
            return(path_1) =>(acc) => {
              if(fields.$==1){
                const t_1=fields.$1;
                return collect((_2) =>((collect_1(t_1))(_2[0]))(_c_3.Cons(_2[1], acc)), fields.$0.Parse(path_1));
              }
              else return[[path_1, createCase(i, ofList(rev(acc)))]];
            };
          }
          return((collect_1(m_1))(_c_12.New(p, path.QueryArgs, path.FormData, path.Method, path.Body)))(_c_3.Empty);
        }
      }
    }
    else return[];
    ...
    const fields=p[2];
    const p_1=get(p[1], 0);
    const casePath=[_c_12.Segment(ofArray(p_1[1]), p_1[0])];
    if(fields.length==0)return Some(casePath);
      ...
      return forall_1((o) => o!=null, fieldParts)?Some(append_1(casePath, collect((o) => o.$0, fieldParts))):null;
    }
  });
}
...
function Write(router_1, endpoint){
  ...
  return o==null?null:Some(_c_12.Combine(o.$0));
}
let _c_12=Lazy((_i) => class Route {
  static {
    _c_12=_i(this);
  }
  Segments;
  ...
  static FromHash(path, strict){
    ...
    if(m===-1)return _c_12.Empty;
    else {
      const h=path.substring(m+1);
      return strict!=null&&strict.$0?h==""||h=="/"?_c_12.Empty:StartsWith(h, "/")?_c_12.FromUrl(h.substring(1), Some(true)):_c_12.Segment_2(h):_c_12.FromUrl(path.substring(m), Some(false));
    }
  }
  static Segment(s, m){
    return _c_12.New(s, _c_12.Empty.QueryArgs, _c_12.Empty.FormData, m, _c_12.Empty.Body);
  }
  static get Empty(){
    return _c_12.New(_c_3.Empty, new _c_24("New", []), new _c_24("New", []), null, Some(null));
  }
  static FromUrl(path, strict){
    const m=path.indexOf("?");
    const p=m===-1?[path, new _c_24("New", [])]:[Substring(path, 0, m), _c_12.ParseQuery(path.substring(m+1))];
    return _c_12.New(ofArray(SplitChars(p[0], ["/"], strict!=null&&strict.$0?0:1)), p[1], _c_12.Empty.FormData, _c_12.Empty.Method, _c_12.Empty.Body);
  }
  static Segment_2(s){
    return _c_12.New(ofArray([s]), _c_12.Empty.QueryArgs, _c_12.Empty.FormData, _c_12.Empty.Method, _c_12.Empty.Body);
  }
  static ParseQuery(q){
  ...
  static Combine(paths){
    ...
    if(m===0)return _c_12.Empty;
    else if(m===1)return get(paths_1, 0);
    else {
      method=null;
      body=null;
      const segments=[];
      queryArgs=new _c_24("New", []);
      formData=new _c_24("New", []);
      iter_2((p) => {
        const m_1=p.Method;
      ...
      return _c_12.New(ofSeq(segments), queryArgs, formData, method, body);
    }
  }
  static New(Segments, QueryArgs, FormData, Method, Body){
    return Create_2(_c_12, {
      Segments:Segments, 
      QueryArgs:QueryArgs, 
      FormData:FormData, 
      Method:Method, 
...
let _c_13=Lazy((_i) => class TemplateInstance extends _c_1 {
  static {
    _c_13=_i(this);
  }
  doc;
...
let _c_15=Lazy((_i) => {
  Force(_c_9);
  return class Text extends _c_9 {
    static {
      _c_15=_i(this);
    }
    name;
...
function EventQ2(_1, holeName, ti, f){
  return new _c_21(holeName, (el) =>(ev) => {
    const i=ti();
    i.SetAnchorRoot(el);
    return f({
      Vars:i, 
...
function CompleteHoles(key, filledHoles, vars){
  ...
  const filledVars=new _c_25("New_3");
  ...
  return[append_1(filledHoles, choose((_1) => {
    const name=_1[0];
    const ty=_1[1];
    const d=_1[2];
    if(filledVars.Contains(name))return null;
    else {
      const r=ty===0?_c_26.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_7.Create_1(o==null?"":o.$0);
        return new _c_20(name, _2);
      }):ty===1?_c_26.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_7.Create_1(o==null?0:o.$0);
        return new _c_19(name, _2);
      }):ty===2?_c_26.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_7.Create_1(o==null?false:o.$0);
        return new _c_27(name, _2);
      }):ty===3?_c_26.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_7.Create_1(o==null?-8640000000000000:o.$0);
        return new _c_28(name, _2);
      }):ty===4?_c_26.GetOrAddHoleFor(key, name, () => new _c_29(name, _c_7.Create_1([]))):ty===5?_c_26.GetOrAddHoleFor(key, name, () => new _c_30(name, _c_7.Create_1(Some(globalThis.document.querySelector("[ws-dom="+name+"]"))))):ty===6?_c_26.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_7.Create_1(o==null?[]:o.$0);
        return new _c_31(name, _2);
...
let _c_16=Lazy((_i) => class Doc extends _c_1 {
  static {
    _c_16=_i(this);
  }
  docNode;
  ...
  static EmbedView(view){
    ...
    return _c_16.Mk(EmbedDoc(node), Map(() => { }, Bind((doc) => {
  ...
  static Convert(render, view){
    return _c_16.Flatten(MapSeqCached(render, view));
  }
  ...
  static Flatten(view){
    return _c_16.EmbedView(Map(_c_16.Concat, view));
  }
  static get Empty(){
    return _c_16.Mk(null, Const());
  }
  static Concat(xs){
    return TreeReduce(_c_16.Empty, _c_16.Append, ofSeqNonCopying(xs));
  }
  static TextNode(v){
    return _c_16.Mk(TextNodeDoc(globalThis.document.createTextNode(v)), Const());
  }
  static TextView(txt){
    const node=CreateTextNode();
    return _c_16.Mk(TextDoc(node), Map((t) => {
      UpdateTextNode(node, t);
    }, txt));
  }
  static Append(a, b){
    return _c_16.Mk(AppendDoc(a.docNode, b.docNode), Map2Unit(a.updates, b.updates));
  }
...
function counter(){
  return _c_33.counter;
}
let _c_17=Lazy((_i) => class ArrayStorage extends _c_1 {
  static {
    _c_17=_i(this);
  }
  init;
...
function ofSeq_1(xs){
  ...
  else if(xs instanceof _c_3)return ofList(xs);
  else {
    const q=[];
    const o=Get(xs);
    try {
...
let _c_18=Lazy((_i) => {
  Force(_c_9);
  return class TextView extends _c_9 {
    static {
      _c_18=_i(this);
    }
    name;
...
let _c_19=Lazy((_i) => {
  Force(_c_9);
  return class VarFloatUnchecked extends _c_9 {
    static {
      _c_19=_i(this);
    }
    name;
...
let _c_20=Lazy((_i) => {
  Force(_c_9);
  return class VarStr extends _c_9 {
    static {
      _c_20=_i(this);
    }
    name;
...
let _c_21=Lazy((_i) => {
  Force(_c_9);
  return class EventQ extends _c_9 {
    static {
      _c_21=_i(this);
    }
    name;
...
function CreateElemNode(el, attr, children){
  ...
  return _c_36.New(attr_1, children, null, el, Int(), GetOptional(attr_1.OnAfterRender));
}
...
let _c_22=Lazy((_i) => class Scheduler extends _c_1 {
  static {
    _c_22=_i(this);
  }
  idle;
...
let _c_23=Lazy((_i) => class T extends _c_1 {
  static {
    _c_23=_i(this);
  }
  s;
...
let _c_24=Lazy((_i) => class FSharpMap extends _c_1 {
  static {
    _c_24=_i(this);
  }
  tree;
  ...
  Add_1(k, v){
    return new _c_24("New_1", Add(_c_35.New(k, v), this.tree));
  }
  get IsEmpty(){
...
function OfArray(a){
  return new _c_24("New_1", OfSeq(map_1((_1) => _c_35.New(_1[0], _1[1]), a)));
}
...
let _c_25=Lazy((_i) => class HashSet extends _c_1 {
  static {
    _c_25=_i(this);
  }
  equals;
  ...
  IntersectWith(xs){
    const other=new _c_25("New_4", xs, this.equals, this.hash);
...
let _c_26=Lazy((_i) => class TemplateInitializer extends _c_1 {
  static {
    _c_26=_i(this);
  }
  static init;
  ...
  static GetHolesFor(id){
    let o;
    const m=(o=null,[_c_26.initialized.TryGetValue(id, {get:() => o, set:(v) => {
      o=v;
    }}), o]);
    if(m[0])return m[1];
    else {
      const d=new _c_10("New_5");
      _c_26.initialized.set_Item(id, d);
      return d;
    }
  }
  static {
    _c_26.initialized=new _c_10("New_5");
    _c_26.instances=new _c_10("New_5");
  }
});
let _c_27=Lazy((_i) => {
  Force(_c_9);
  return class VarBool extends _c_9 {
    static {
      _c_27=_i(this);
    }
    name;
...
let _c_28=Lazy((_i) => {
  Force(_c_9);
  return class VarDateTime extends _c_9 {
    static {
      _c_28=_i(this);
    }
    name;
...
let _c_29=Lazy((_i) => {
  Force(_c_9);
  return class VarFile extends _c_9 {
    static {
      _c_29=_i(this);
    }
    name;
...
let _c_30=Lazy((_i) => {
  Force(_c_9);
  return class VarDomElement extends _c_9 {
    static {
      _c_30=_i(this);
    }
    name;
...
let _c_31=Lazy((_i) => {
  Force(_c_9);
  return class VarStrList extends _c_9 {
    static {
      _c_31=_i(this);
    }
    name;
...
let _c_32=Lazy((_i) => class Exception extends _c_1 {
  static {
    _c_32=_i(this);
  }
});
...
function NamedTemplate(baseName, name, fillWith){
  ...
  return m[0]?ChildrenTemplate(m[1].cloneNode(true), fillWith):(console.warn("Local template doesn't exist", name),_c_16.Empty);
}
function RenderedFullDocTemplate(){
  return _c_38.RenderedFullDocTemplate;
}
function PrepareTemplateStrict(baseName, name, fakeroot, prepareLocalTemplate){
  const processedHTML5Templates=new _c_25("New_3");
        ...
        case 1:
          ...
          if(instBaseName!=""&&!LoadedTemplates().ContainsKey(instBaseName))return failNotLoaded(instName);
            ...
            if(!d.ContainsKey(instName))return failNotLoaded(instName);
              ...
              const usedHoles=new _c_25("New_3");
...
function ChildrenTemplate(el, fillWith){
  ...
  return!Equals(m, null)&&m.length===1&&(get(m, 0)instanceof Node&&(Equals(get(m, 0).nodeType, Node.ELEMENT_NODE)&&(_1=get(m, 0),true)))?_c_39.TreeNode(docTreeNode, updates):_c_16.Mk(TreeDoc(docTreeNode), updates);
}
function set_RenderedFullDocTemplate(_1){
  _c_38.RenderedFullDocTemplate=_1;
}
function LocalTemplatesLoaded(){
  return _c_38.LocalTemplatesLoaded;
}
function set_LocalTemplatesLoaded(_1){
  _c_38.LocalTemplatesLoaded=_1;
}
function LoadNestedTemplates(root, baseName){
  ...
  const instantiated=new _c_25("New_3");
...
function InlineTemplate(el, fillWith){
  ...
  const tryGetAsDoc=(name) => {
    ...
    if(m[0]){
      const th=m[1];
      if(th instanceof _c_14)return Some(th.Value);
      else if(th instanceof _c_15)return Some(_c_16.TextNode(th.Value));
      else {
        const o_1=th.ForTextView();
        return o_1==null?null:Some(_c_16.TextView(o_1.$0));
      }
    }
    else return null;
  };
  foreachNotPreserved(el, "[ws-hole]", (p) => {
    ...
    if(m!=null&&m.$==1){
      ...
      holes.push(_c_36.New(Empty(p), doc.docNode, null, p, Int(), null));
  ...
  foreachNotPreserved(el, "[ws-replace]", (e_1) => {
    ...
    if(m!=null&&m.$==1){
      ...
      holes.push(_c_36.New(Empty(p), doc.docNode, Some([before, after]), p, Int(), null));
      updates.push(doc.updates);
    }
  });
  ...
  foreachNotPreserved(el, "[ws-on]", (e_1) => {
    addAttr(e_1, _c_43.Concat(choose((x_1) => {
      ...
      if(m[0]){
        const th=m[1];
        return th instanceof _c_42?Some(Handler(get(a, 0), th.Value)):th instanceof _c_21?Some(_c_43.Handler(get(a, 0), th.Value)):(console.warn("Event hole on"+get(a, 0)+" filled with non-event data", get(a, 1)),null);
      }
      else return null;
    ...
    for(let i=0, _5=holeAttrs.length-1;i<=_5;i++)((() => {
      ...
      const value=foldBack((_7, _8) =>(((t) => {
        ...
        return(t_1) => {
          ...
          return holeContent.$==1?[textBefore_1, _c_3.Cons(textAfter==""?holeContent.$0:Map((s_5) => s_5+textAfter, holeContent.$0), views)]:[textBefore_1+holeContent.$0+textAfter, views];
        };
      })(_7))(_8), res, [finalText, _c_3.Empty]);
      if(value[1].$==1){
        if(value[1].$1.$==1){
          if(value[1].$1.$1.$==1){
            if(value[1].$1.$1.$1.$==0){
      ...
      else _6=_c_43.Create(attrName, value[0]);
...
let _c_33=Lazy((_i) => class $StartupCode_Abbrev {
  static {
    _c_33=_i(this);
  }
  static counter;
...
let _c_34=Lazy((_i) => class $StartupCode_Concurrency {
  static {
    _c_34=_i(this);
  }
  static GetCT;
...
let _c_35=Lazy((_i) => class Pair {
  ...
  static New(Key, Value_1){
    return Create_2(_c_35, {Key:Key, Value:Value_1});
  }
});
function notPresent(){
  throw new _c_52("New");
...
let _c_36=Lazy((_i) => class DocElemNode {
  static {
    _c_36=_i(this);
  }
  Attr;
...
function fromSeq(s){
  const a=ofSeq_1(map_1((_1) => _c_35.New(_1[0], _1[1]), distinctBy((t) => t[0], rev_1(s))));
  sortInPlace(a);
...
function WriteQuery(q){
  return concat_2("&", map_1((_1) => _1[0]+"="+_1[1], ToSeq(q)));
}
let _c_38=Lazy((_i) => class $StartupCode_Templates {
  static {
    _c_38=_i(this);
  }
...
let _c_39=Lazy((_i) => {
  Force(_c_16);
  return class Elt extends _c_16 {
    static {
      _c_39=_i(this);
    }
    docNode_1;
    ...
    static TreeNode(tree, updates){
      const rvUpdates=_c_46.Create(updates);
...
function BatchUpdatesEnabled(){
  return _c_48.BatchUpdatesEnabled;
}
    ...
    while(true)
      {
        if(t_1==null)return spine.$==1?Some([spine.$0[0], [spine.$0[1], spine.$1]]):null;
          ...
          t_2=t_1;
          t_1=t_2.Right;
          spine=_c_3.Cons([t_2.Node, t_2.Left], spine);
        }
        else {
          t_2=t_1;
          t_1=t_2.Left;
          spine=_c_3.Cons([t_2.Node, t_2.Right], spine);
        }
      }
  }
  return unfold((_1) => gen(_1[0], _1[1]), [t, _c_3.Empty]);
}
...
function Static(attr){
  return _c_43.A3(attr);
}
function Dynamic(view, set_1){
  return _c_43.A1(new _c_53(view, set_1));
}
function EmptyAttr(){
...
let _c_41=Lazy((_i) => {
  Force(_c_9);
  return class Attribute extends _c_9 {
    static {
      _c_41=_i(this);
    }
    name;
...
let _c_42=Lazy((_i) => {
  Force(_c_9);
  return class Event extends _c_9 {
    static {
      _c_42=_i(this);
    }
    name;
...
function ValueWith(bind, var_1){
  const p=bind(var_1);
  return _c_43.Append(Static(p[0]), DynamicCustom(p[1], p[2]));
}
function DynamicCustom(set_1, view){
  return Dynamic(view, set_1);
}
let _c_43=Lazy((_i) => class Attr {
  static {
    _c_43=_i(this);
  }
  static Handler(event, q){
    return _c_43.HandlerImpl(event, q);
  }
  static Concat(xs){
    const x=ofSeqNonCopying(xs);
    return TreeReduce(EmptyAttr(), _c_43.Append, x);
  }
...
let _c_44=Lazy((_i) => {
  Force(_c_9);
  return class AfterRender_1 extends _c_9 {
    static {
      _c_44=_i(this);
    }
    name;
...
let _c_45=Lazy((_i) => {
  Force(_c_9);
  return class AfterRenderQ extends _c_9 {
    static {
      _c_45=_i(this);
    }
    name;
...
let _c_46=Lazy((_i) => class Updates_1 {
  static {
    _c_46=_i(this);
  }
  c;
...
let _c_47=Lazy((_i) => class ValueCollection extends _c_1 {
  static {
    _c_47=_i(this);
  }
  d;
...
function get_Empty_1(){
  return NodeSet(new _c_25("New_3"));
}
function FindAll(doc){
  ...
  loop(doc);
  return NodeSet(new _c_25("New_2", q));
}
...
let _c_49=Lazy((_i) => class KeyCollection extends _c_1 {
  static {
    _c_49=_i(this);
  }
  d;
...
function Filter_1(ok, set_1){
  return new _c_25("New_2", filter(ok, ToArray_2(set_1)));
}
function Except_1(excluded, included){
  const set_1=new _c_25("New_2", ToArray_2(included));
...
function Intersect_1(a, b){
  const set_1=new _c_25("New_2", ToArray_2(a));
